function getData(pos) {
  axios
    .get(
      ...
      "https://api.openweathermap.org/data/2.5/weather?lat=" + pos.lat + "&lon=" + pos.lon + "&appid=d844ff38165a265c87991893a6ca3c42&units=metric"
    )
    .then(function (response) {
      ...
      document.getElementById("vreme0").innerText = data.weather[0].main + ", " + data.main.temp + "°C";
      ...
      document.getElementById("imgvreme").src = "http://openweathermap.org/img/w/" + data.weather[0].icon + ".png";
      })
